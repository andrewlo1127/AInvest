...
CREATE TABLE `code` (
  ...
  `description` int(11) NOT NULL COMMENT '策略描述'
...
CREATE TABLE `target` (
  ...
  `codename` text NOT NULL COMMENT '標的名稱',
  `member_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `test_body` (
  ...
  `appear_date` int(11) NOT NULL,
  `enter_price` int(11) NOT NULL,
  `appear_price` int(11) NOT NULL,
...
CREATE TABLE `test_head` (
  ...
  `appear_time` int(11) NOT NULL,
  `continue_time` int(11) NOT NULL,
  `acc_profit_margin` int(11) NOT NULL,
