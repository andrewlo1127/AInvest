...
class IterfaceWindowLogined(QWidget):#登录后画面
    ...
    def resizeEvent(self, event):
        ...
        self.comboBox.setGeometry(window_width/(962/135),window_height/(525/105) , window_width/(962/125), window_height/(525/22))
        ...
        self.label.setGeometry(window_width/(962/30),window_height/(525/56) , window_width/(962/51), window_height/(525/21))
        self.label_3.setGeometry(window_width/(962/30),window_height/(525/104) , window_width/(962/51), window_height/(525/21))
        self.label_4.setGeometry(window_width/(962/400),window_height/(525/56) , window_width/(962/51), window_height/(525/21))
        self.label_5.setGeometry(window_width/(962/400),window_height/(525/104) , window_width/(962/51), window_height/(525/21))
    ...
    def initUI(self):#一些界面UI,UX设定基本不动
        ...
        self.parameter_data = ['0056.TW','KDCross','2014-07-26','2024-07-26','code'] #參數默認設定 
    ...
    def load_trades_data_defualt(self): #加载交易明细画面（默認）
        ...
        import test1
        trades = test1.test1_main(self.parameter_data,self.member_id) #總之這種的就是呼叫test1 parameter_data是給test1的參數ctrl+f可以找到在哪
    ...
    def load_trades_data(self): #加载交易明细画面 啊這個就跟上面的一樣只是他不是默認的 基本要改的話就去改parameter_data
        ...
        import test1
        self.update_html()
        trades = test1.test1_main(self.parameter_data,self.member_id)
        self.viewer = HtmlViewer()        
...
class MemberInfoDialog(QDialog):#会员资讯画面
    def __init__(self, db_connection, member_id,window_width,window_height,big_label_font,small_label_font,ex_small_label_font_size ,parent=None):
        ...
        self.label_8.setGeometry(window_width/(962/50),window_height/(525/129) , window_width/(962/71), window_height/(525/20))
